...
import src.strategy.rules.rule_13_rsi_overbought_oversold_signal.v1 as rule_13_rsi_overbought_oversold_signal_v1
...
ACTIVE_RULES: list[ModuleType] = [
    ...
    rule_13_rsi_overbought_oversold_signal_v1,
