...
import src.strategy.rules.rule_16_volume_weighted_ma_crossover_w.v1 as rule_16_volume_weighted_ma_crossover_w_v1
...
import src.strategy.rules.rule_14_ema_crossover_trend_following.v1 as rule_14_ema_crossover_trend_following_v1
...
ACTIVE_RULES: list[ModuleType] = [
    ...
    rule_14_ema_crossover_trend_following_v1,
    ...
    rule_16_volume_weighted_ma_crossover_w_v1,
]
