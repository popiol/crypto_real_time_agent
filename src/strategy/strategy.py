...
import src.strategy.rules.rule_02_bollinger_band.v9 as rule_02_bollinger_band_v9
import src.strategy.rules.rule_13_bollinger_band_reversal_with_c.v1 as rule_13_bollinger_band_reversal_with_c_v1
...
ACTIVE_RULES: list[ModuleType] = [
    ...
    rule_13_bollinger_band_reversal_with_c_v1,
    rule_02_bollinger_band_v9,
]
