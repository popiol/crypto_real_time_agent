...
# Relaxed thresholds for BB_RSI_MeanReversion_V2
BB_PERCENT_B_OVERSOLD_THRESHOLD = 0.3
RSI_OVERSOLD_THRESHOLD = 45
BB_PERCENT_B_OVERBOUGHT_THRESHOLD = 0.7
...
def signal(data: MarketData) -> list[BuySignal | SellSignal]:
    """
    Implements the Relaxed Mean-Reversion with BB %B and RSI (BB_RSI_MeanReversion_V2).

    A buy signal is generated when Bollinger Bands %B falls below 0.3
    AND the 14-period RSI is simultaneously below 45.

    A sell signal is generated when Bollinger Bands %B rises above 0.7
    AND the 14-period RSI is simultaneously above 55.
    """
