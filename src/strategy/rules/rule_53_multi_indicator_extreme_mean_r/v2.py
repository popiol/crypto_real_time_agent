...
def signal(data: MarketData) -> list[BuySignal | SellSignal]:
    """
    Generates BUY/SELL signals based on the "Enhanced RSI-KCD-PMMD Mean Reversion Strategy" rule.
    ...
    for pair, pair_data in data.items():
        ...
        if (hourly_rsi < 30 and 
            ...
            signals.append(BuySignal(
                ...
                price=current_price,
                rule_id="RSI_KCD_PMMD_Oversold_Long",
        ...
        # SELL Signal: HourlyRSI > 70 AND KeltnerChannelDeviation > 4.0 AND PriceToMonthlyMeanDeviation > 4.0
            ...
            signals.append(SellSignal(
                ...
                timestamp=current_timestamp,
                price=current_price,
                rule_id="RSI_KCD_PMMD_Overbought_Short",
                confidence=1.0 # Placeholder confidence
            ))
