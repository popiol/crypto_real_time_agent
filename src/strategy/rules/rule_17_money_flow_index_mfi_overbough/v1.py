...
MFI_OVERBOUGHT = 80
MFI_OVERSOLD = 20
RULE_ID = "9725a558-a597-4aef-8426-f58b44e71d4f"
...
def signal(data: MarketData) -> list[BuySignal | SellSignal]:
    ...
    A Buy signal is generated when MFI drops below MFI_OVERSOLD (e.g., 20).
    A Sell signal is generated when MFI rises above MFI_OVERBOUGHT (e.g., 80).
    """
    ...
    for pair, pair_data in data.items():
        ...
        # Generate Buy Signal: MFI falls below the oversold threshold
        if mfi < MFI_OVERSOLD:
        ...
        # Generate Sell Signal: MFI rises above the overbought threshold
