...
RULE_ID = "extreme_oversold_rebound_v2"
...
# Buy/Sell thresholds
RSI_OVERSOLD_BUY = 20
ZSCORE_OVERSOLD_BUY = -2.0
BB_WIDTH_THRESHOLD_BUY = 0.01
...
def signal(data: MarketData) -> list[BuySignal | SellSignal]:
    ...
    for pair, pair_data in data.items():
        ...
        # 1. RSI(14) is extremely oversold (< 20)
        # 2. Price Z-Score(20) is significantly undervalued (< -2.0)
        # 3. Bollinger Band Width(20) is very low (< 0.01)
        buy_condition = (
